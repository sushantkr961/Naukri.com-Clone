    ...
    <Box paddingTop='70px'>
        ...
        >
            ...
            <InputGroup size='md'>
              ...
              />
              <InputRightElement >
                <Button padding='25px 70px' borderRadius='25px' color='white' fontSize='19px' bg='#457EFF'>Search
                </Button>
              </InputRightElement>
            </InputGroup>
            </Box>
...
//   return (
//     <Box>
//         <Text fontSize='5xl' noOfLines={1} fontFamily='Roboto Slab' fontWeight='extrabold'>Find your dream job now </Text>
//     </Box>
//   )
// }
